...
namespace simd
{
    ...
    template <>
    inline constexpr bool SupportsSIMD<long> = true;
...
#if defined(RMATH_AVX)
    // float AVX
    inline auto loadf(const float *ptr) { return _mm256_load_ps(ptr); }
    inline auto loaduf(const float *ptr) { return _mm256_loadu_ps(ptr); }
    inline void storeuf(float *ptr, __m256 vec) { _mm256_storeu_ps(ptr, vec); }
    inline auto set1f(float val) { return _mm256_set1_ps(val); }
    inline auto addf(__m256 a, __m256 b) { return _mm256_add_ps(a, b); }
    inline auto subf(__m256 a, __m256 b) { return _mm256_sub_ps(a, b); }
    inline auto mulf(__m256 a, __m256 b) { return _mm256_mul_ps(a, b); }
    inline auto divf(__m256 a, __m256 b) { return _mm256_div_ps(a, b); }
    inline auto fmaddf(__m256 a, __m256 b, __m256 c) {
    ...
    inline auto zerof() { return _mm256_setzero_ps(); }

    // double AVX
    inline auto loadd(const double *ptr) { return _mm256_load_pd(ptr); }
    inline auto loadud(const double *ptr) { return _mm256_loadu_pd(ptr); }
    inline void storeud(double *ptr, __m256d vec) { _mm256_storeu_pd(ptr, vec); }
    inline auto set1d(double val) { return _mm256_set1_pd(val); }
    inline auto addd(__m256d a, __m256d b) { return _mm256_add_pd(a, b); }
    inline auto subd(__m256d a, __m256d b) { return _mm256_sub_pd(a, b); }
    inline auto muld(__m256d a, __m256d b) { return _mm256_mul_pd(a, b); }
    inline auto divd(__m256d a, __m256d b) { return _mm256_div_pd(a, b); }
    inline auto fmaddd(__m256d a, __m256d b, __m256d c) {
#if defined(RMATH_AVX2)
    ...
    inline double haddd(__m256d vec) {
    ...
    inline auto zerod() { return _mm256_setzero_pd(); }

    // int AVX
    inline auto loadi(const int *ptr) { return _mm256_load_si256(reinterpret_cast<const __m256i*>(ptr)); }
    inline auto loadui(const int *ptr) { return _mm256_loadu_si256(reinterpret_cast<const __m256i*>(ptr)); }
    inline void storeui(int *ptr, __m256i vec) { _mm256_storeu_si256(reinterpret_cast<__m256i*>(ptr), vec); }
    inline auto set1i(int val) { return _mm256_set1_epi32(val); }
    inline auto addi(__m256i a, __m256i b) { return _mm256_add_epi32(a, b); }
    inline auto subi(__m256i a, __m256i b) { return _mm256_sub_epi32(a, b); }
    inline auto muli(__m256i a, __m256i b) {
#if defined(RMATH_AVX2)
    ...
    inline auto zeroi() { return _mm256_setzero_si256(); }

#elif defined(RMATH_SSE2)
    // float SSE
    inline auto loadf(const float *ptr) { return _mm_load_ps(ptr); }
    inline auto loaduf(const float *ptr) { return _mm_loadu_ps(ptr); }
    inline void storeuf(float *ptr, __m128 vec) { _mm_storeu_ps(ptr, vec); }
    inline auto set1f(float val) { return _mm_set1_ps(val); }
    inline auto addf(__m128 a, __m128 b) { return _mm_add_ps(a, b); }
    inline auto subf(__m128 a, __m128 b) { return _mm_sub_ps(a, b); }
    inline auto mulf(__m128 a, __m128 b) { return _mm_mul_ps(a, b); }
    inline auto divf(__m128 a, __m128 b) { return _mm_div_ps(a, b); }
    inline auto fmaddf(__m128 a, __m128 b, __m128 c) {
        return _mm_add_ps(_mm_mul_ps(a, b), c);
    }
    inline float haddf(__m128 vec) {
    ...
    inline auto zerof() { return _mm_setzero_ps(); }

    // double SSE2
    inline auto loadd(const double *ptr) { return _mm_load_pd(ptr); }
    inline auto loadud(const double *ptr) { return _mm_loadu_pd(ptr); }
    inline void storeud(double *ptr, __m128d vec) { _mm_storeu_pd(ptr, vec); }
    inline auto set1d(double val) { return _mm_set1_pd(val); }
    inline auto addd(__m128d a, __m128d b) { return _mm_add_pd(a, b); }
    inline auto subd(__m128d a, __m128d b) { return _mm_sub_pd(a, b); }
    inline auto muld(__m128d a, __m128d b) { return _mm_mul_pd(a, b); }
    inline auto divd(__m128d a, __m128d b) { return _mm_div_pd(a, b); }
    inline auto fmaddd(__m128d a, __m128d b, __m128d c) {
        return _mm_add_pd(_mm_mul_pd(a, b), c);
    }
    inline double haddd(__m128d vec) {
        __m128d shuf = _mm_shuffle_pd(vec, vec, _MM_SHUFFLE2(0, 1));
        vec = _mm_add_pd(vec, shuf);
        return _mm_cvtsd_f64(vec);
    }
    inline auto zerod() { return _mm_setzero_pd(); }

    // int SSE2
    inline auto loadi(const int *ptr) { return _mm_load_si128(reinterpret_cast<const __m128i*>(ptr)); }
    inline auto loadui(const int *ptr) { return _mm_loadu_si128(reinterpret_cast<const __m128i*>(ptr)); }
    inline void storeui(int *ptr, __m128i vec) { _mm_storeu_si128(reinterpret_cast<__m128i*>(ptr), vec); }
    inline auto set1i(int val) { return _mm_set1_epi32(val); }
    inline auto addi(__m128i a, __m128i b) { return _mm_add_epi32(a, b); }
    inline auto subi(__m128i a, __m128i b) { return _mm_sub_epi32(a, b); }
    inline auto muli(__m128i a, __m128i b) {
    ...
    inline auto zeroi() { return _mm_setzero_si128(); }
#endif

    // Generic dispatch wrappers
    template <typename T>
    inline auto load(const T *ptr) {
        if constexpr (std::is_same_v<T, float>) return loadf(ptr);
        else if constexpr (std::is_same_v<T, double>) return loadd(ptr);
        else if constexpr (std::is_same_v<T, int>) return loadi(ptr);
    }

    template <typename T>
    inline auto loadu(const T *ptr) {
    ...
    template <typename T>
    inline void storeu(T *ptr, auto vec) {
